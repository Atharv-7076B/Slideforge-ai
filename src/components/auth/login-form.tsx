  ...
  return (
    <div className="space-y-3">
      ...
      <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
        <Button
          variant="outline"
          className="w-full h-11 rounded-xl gap-3 border-zinc-800 hover:border-zinc-700 bg-zinc-900/40 hover:bg-zinc-900 text-zinc-100 font-medium transition-all"
        ...
        >
          ...
          {isSubmitting === 'github' ? 'Connecting...' : 'Continue with GitHub'}
        </Button>
      </motion.div>
